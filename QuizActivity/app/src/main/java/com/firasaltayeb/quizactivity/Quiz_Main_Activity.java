...
public class Quiz_Main_Activity extends Activity {
    ...
    public Quiz_Questions_List questionsList = new Quiz_Questions_List();
    public Quiz_Answers_List answersList = new Quiz_Answers_List();
    ...
    public void checkQuestionNumber(){
        if(questionNumber == 10){
            Intent intent = new Intent(this, Quiz_Statistics_Activity.class);
