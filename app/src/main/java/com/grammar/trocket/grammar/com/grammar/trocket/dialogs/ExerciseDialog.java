 ...
 */
public class ExerciseDialog extends AlertDialog.Builder {
    ...
    public ExerciseDialog(Context context, final ArrayAdapter<String> quizOptions, ArrayList<Quiz> quizList) {
        super(context);
